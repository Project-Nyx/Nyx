...
public class FieldRef extends ConfigElement {
    @DefaultPackage({"org.projectnyx.token.request", "org.projectnyx.token.response"}) public Class<? extends Request> name;
    public String field;
}
